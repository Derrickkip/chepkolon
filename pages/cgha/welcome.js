        ...
        <div className='hero-image-area opacityOn'>
            <div className='hero-images-area'>
                <div className='hero-images-area-inner'>
                    <div>
                        <Image src={require('../../assets/assembly.jpg')} alt="director" style={{position: "absolute", top: '-34px', left: '0px', width: '1254px', height: '836px', opacity: '1'}}/>
                    </div>
                </div>
            </div>
        </div>
        <div className='sl-content-area clearfix'>
            ...
            <div className='page-title'>
                <div className='secondLvlCss'>
                    <h1>Chepkolon Green Highlands Academy</h1>
                </div>
            </div>
            <div className='sl-content-main clearfix'>
                ...
                <div className="breadcrumbs">
                        ...
                        <Link href="/cgha/welcome">CGHA</Link>
                        <span className='bdivider'></span>
                ...
                <div className='sl-content-left'>
                    <div className='in-this-section'>
                        In Chepkolon Green Highlands Academy
                    </div>
                    <ul className='mk-tree-menu'>
                        <li className='clearfix'><Link href="/about-us/welcome">welcome</Link></li>
                        <li className='clearfix'><Link href="/">Boarding</Link></li>
